...
- [เกม Platformer ที่จำกัดการกระโดดทำไม](https://github.com/tinarskii/Leviora)
- [เครื่องคิดเลข if/else](https://github.com/tinarskii/simple-javascript-calculator)
- [รวบรวมคำคมจาก Curry](https://github.com/tinarskii/awesome-curry-quotes)
